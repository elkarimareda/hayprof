...
return [
    ...
    */
    ...
    'twitter' => [
        ...
        'redirect' => env('TWITTER_REDIRECT_URI', env('APP_URL') . '/api/auth/social/twitter/callback'),
    ],

    'github' => [
        'client_id' => env('GITHUB_CLIENT_ID'),
        'client_secret' => env('GITHUB_CLIENT_SECRET'),
        'redirect' => env('GITHUB_REDIRECT_URI', env('APP_URL') . '/api/auth/social/github/callback'),
    ],
